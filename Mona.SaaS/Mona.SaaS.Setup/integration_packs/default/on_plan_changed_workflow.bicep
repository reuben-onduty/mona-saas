...
var name = 'mona-on-subscription-plan-changed-${deploymentName}'
var displayName = 'On subscription plan changed'
var description = 'This workflow is automatically triggered after Mona has been notified by the AppSource/Marketplace that a subscription plan has been changed.'
var eventType = 'Mona.SaaS.Marketplace.SubscriptionPlanChanged'
var triggerName = 'When_a_subscription_plan_is_changed'
